...
namespace SemanticICP {
    ...
    class GICPCostFunctionT : public ceres::SizedCostFunction<1,Sophus::SE3d::num_parameters>
    {
        public:
        static const int K = 3;
        GICPCostFunctionT ( const pcl::PointXYZRGB point_source,
                           const pcl::PointXYZRGB point_target,
